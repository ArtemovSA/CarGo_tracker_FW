...
void WL_prepare_DATA(char* pack, GNSS_data_t *data, float temp_mcu, float bat_voltage, double power, uint8_t quality, uint32_t status, uint8_t count_temper, float *temper_sensors); //Create package DATA
