...
extern void PORTIO_enter_DefaultMode_from_RESET(void) {
	...
	/* Pin PA4 is configured to Input enabled with pull-down and filter */
	...
	/* Pin PA15 is configured to Push-pull with alt. drive strength */
	...
	/* Pin PB12 is configured to Input enabled with pull-down and filter */
	GPIO->P[1].MODEH = (GPIO->P[1].MODEH & ~_GPIO_P_MODEH_MODE12_MASK)
			| GPIO_P_MODEH_MODE12_INPUTPULLFILTER;
	// [Port B Configuration]$
	...
	/* Pin PC0 is configured to Input enabled with pull-down and filter */
	...
	/* Pin PC8 is configured to Input enabled with pull-down and filter */
	...
	/* Pin PD3 is configured to Push-pull with alt. drive strength */
	...
	/* Pin PD6 is configured to Input enabled with pull-down and filter */
	GPIO->P[3].MODEL = (GPIO->P[3].MODEL & ~_GPIO_P_MODEL_MODE6_MASK)
			| GPIO_P_MODEL_MODE6_INPUTPULLFILTER;

	/* Pin PD8 is configured to Input enabled with pull-down and filter */
	...
	/* Pin PE8 is configured to Input enabled with pull-down */
	GPIO->P[4].MODEH = (GPIO->P[4].MODEH & ~_GPIO_P_MODEH_MODE8_MASK)
			| GPIO_P_MODEH_MODE8_INPUTPULL;

	/* Pin PE9 is configured to Input enabled with pull-down and filter */
	...
	/* Pin PE14 is configured to Input enabled with pull-down and filter */
	GPIO->P[4].MODEH = (GPIO->P[4].MODEH & ~_GPIO_P_MODEH_MODE14_MASK)
			| GPIO_P_MODEH_MODE14_INPUTPULLFILTER;
	...
	/* Pin PF5 is configured to Input enabled with pull-down and filter */
	GPIO->P[5].MODEL = (GPIO->P[5].MODEL & ~_GPIO_P_MODEL_MODE5_MASK)
			| GPIO_P_MODEL_MODE5_INPUTPULLFILTER;

	/* Pin PF12 is configured to Push-pull with alt. drive strength */
